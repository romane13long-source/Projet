        ...
        if 'data' in data and 'popularTitles' in data['data']:
            ...
            for movie in movies:
                ...
                if movie_id not in seen_ids:
                    ...
                    full_path = movie['node']['content']['fullPath']
...
with open('justwatch_urls.json', 'w', encoding='utf-8') as f:
    json.dump(all_urls, f, indent=2, ensure_ascii=False)

print(f"Termine: {len(all_urls)} URLs sauvegardees dans justwatch_urls.json")